...
const MyCoupons = props => {
  ...
  const[actives,setActivesCoupon]=useState([
    {
      ...
      discount:'40',
      aed:'20.00',progress:0.4,price:84.50,
    ...
    },
    {
      ...
      image:'../../assets/images/carwash.png',subImage:'../../assets/images/carwash.png',
      discount:'40',
      aed:'20.00',progress:0.7,price:84.50,
      expireTime:'May 09 2021'
    }]);
    const[expires,setExpiresCoupons]=useState([
      {
        ...
        image:'../../assets/images/carwash.png',subImage:'../../assets/images/carwash.png',
        discount:'40',
        aed:'20.00',progress:1,price:84.50,
        expireTime:'May 09 2021'
      },
      {
        bussinessName:'Total Al Safeer Car Wash…',address:'Sharjah Al nahada road',
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1, paddingHorizontal: mvs(16),backgroundColor:allColors.tabBackground }}>
          {actives.length>0 || expires.length>0?
           <View style={{flex:1,paddingTop:mvs(10),backgroundColor:allColors.tabBackground}}>
                {actives.length>0? 
               <><Medium label={"Active Coupons"} style={{...styles.title,marginTop:0}}/>
               <FlatList  
                    data={actives}  
                    renderItem={({item}) =>  
                    <CouponItem 
              ...
              {expires.length>0? 
               <><Medium label={"Expired Coupons"} style={{...styles.title,marginTop:mvs(10)}}/>
               <FlatList  
                    data={expires}  
                    renderItem={({item}) =>  
                    <CouponItem 
          ...
          <View style={styles.body}>
            ...
            <Regular label={"Don’t have any active coupons. Your all coupons will show here."} numberOfLines={2} style={styles.welcomeSubText}/>
          </View>}
