  ...
  const[schedule,setScheduleData]=useState([
    {
      ...
      subDetails:'Lorem ipsum dolor sit amet...',progress:0.5,price:34.50,
      bookingTime:'12 February 2021-9:30 AM-10:00 AM',rating:0,isCancelled:false,isLiked:false
    },
    {
      bussinessName:'Total Al Safeer Car Wash…',address:'Sharjah Al nahada road',
      image:'../../assets/images/carwash.png',subImage:'../../assets/images/carwash.png',
      details:'Lorem ipsum dolor Lorem ipsum dolor sit amet...',
      subDetails:'Lorem ipsum dolor sit amet...',progress:0.3,price:84.50,
      bookingTime:'12 February 2021-9:30 AM-10:00 AM',isCancelled:false,rating:0,isLiked:false
    }]);
    const[completed,setCompletedData]=useState([
      {
        ...
        bookingTime:'12 February 2021-9:30 AM-10:00 AM',rating:0,isCancelled:false,isLiked:true
      },
      {
        bussinessName:'Total Al Safeer Car Wash…',address:'Sharjah Al nahada road',
        image:'../../assets/images/carwash.png',subImage:'../../assets/images/carwash.png',
      ...
      const[cancelled,setCancelledData]=useState([
        {
          ...
          details:'Lorem ipsum dolor Lorem ipsum dolor sit amet...',
          subDetails:'Lorem ipsum dolor sit amet...',progress:1,price:34.50,
          bookingTime:'12 February 2021-9:30 AM-10:00 AM',rating:0,isCancelled:true,isLiked:false
        },
        {
          bussinessName:'Total Al Safeer Car Wash…',address:'Sharjah Al nahada road',
          image:'../../assets/images/carwash.png',subImage:'../../assets/images/carwash.png',
          details:'Lorem ipsum dolor Lorem ipsum dolor sit amet...',
          subDetails:'Lorem ipsum dolor sit amet...',progress:1,price:84.50,
          bookingTime:'12 February 2021-9:30 AM-10:00 AM',isCancelled:true,rating:0,isLiked:false
        }]);
  return (
    <SafeAreaView style={styles.container}>
      <StatusBar backgroundColor={'white'} barStyle="dark-content" />
  
      <ScrollView contentContainerStyle={{ flexGrow: 1, paddingHorizontal: mvs(9),backgroundColor:allColors.tabBackground }}>
       {schedule.length>0 || completed.length>0 || cancelled.length>0
         ?<View style={{flex:1,paddingTop:mvs(10),backgroundColor:allColors.tabBackground}}>
             {schedule.length>0? 
               <><Medium label={"Scheduled"} style={{...styles.title,marginTop:0}}/>
               <FlatList  
                    data={schedule}  
                    renderItem={({item}) =>  
                    <ActivityItem 
          ...
          {completed.length>0?
           <>
            <Medium label={"Completed"} style={styles.title}/>
              ...
              {cancelled.length>0?
                <>
              <Medium label={"Cancelled"} style={{...styles.title,color:allColors.red}}/>
              <FlatList  
                    data={cancelled}  
                    renderItem={({item}) =>  
                    <ActivityItem 
