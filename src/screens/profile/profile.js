    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        ...
        <View style={styles.input_container}>
          ...
          <ProfileAction value={value}
            onChange={setValue} label={"Notifications"} leftIcon={"Notification"} rightIcon={"Arrow"} subLabel={"Manage All notifications"} selected={false} style={{ borderBottomLeftRadius: 2, borderBottomRightRadius: 2 }} />
          <ProfileAction value={value2}
            onChange={setValue2} label={"Push Notifications"} leftIcon={"Notification"} rightIcon={"Arrow"} subLabel={"Manage All notifications"} selected={false} style={{ marginTop: mvs(0), borderTopLeftRadius: 1, borderTopRightRadius: 1, borderWidth: 0.3 }} />
