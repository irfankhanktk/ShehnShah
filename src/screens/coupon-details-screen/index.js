            ...
            <View style={styles.body}>
                <ScrollView contentContainerStyle={{ flexGrow: 1, }}>
                    ...
                    <HeadingTitle title={'Coupon Terms & Conditions'} />
                        ...
                        <LabelValue label={'Valid For Up To Total Purchase Value Of'} value={'AED 1,000'}/>
                        <LabelValue label={'Valid For Up To Total Discount Value Of'} value={'AED 1,000'}/>
                        ...
                        <LabelValue label={'Validity Days'} value={'Sun, Mon, Tue,  days of the week only'}/>
                        <LabelValue label={'Validity Time'} value={'Morning 09-12, Afternoon 12-06 only'}/>
                        <LabelValue label={'Booking Is Required '} value={'24 hours Prior'}/>
                        <LabelValue label={'Can Be Redeem From The SHEHNSHAH App Only'} value={''}/>
